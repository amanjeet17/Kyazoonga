...
const Footer = (props) => {
const  socials=props.footersocials
    return(
        ...
        <div className ="container">
          ...
          <div className ="footer-social text-center">
            ...
            <ul>
            {
              socials.map((social) => {
                return (
                  <li><a className ={social.className } href={social.link} target="blank" rel="me">
                    <img src={social.imageURL}alt={social.alt} width="32" height="32"/></a></li>
                )
              })
            }
            </ul>
